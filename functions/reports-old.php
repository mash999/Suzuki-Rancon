...
if($report_type == "excel"){
	...
	if($main_table == "issues" && $parts_table == "issue_records"){
		...
		foreach ($entries as $entry) {
			if($entry->REFERENCE_NUMBER == NULL || empty($entry)){
				$obj->getActiveSheet()->setCellValue('A'.$i,'REQUISITION NUMBER')->getStyle('A'.$i)->getFont()->setBold(true);
				$obj->getActiveSheet()->setCellValue('D'.$i,'REQUESTER NAME')->getStyle('D'.$i)->getFont()->setBold(true);
				$i++;
				$obj->getActiveSheet()->setCellValue('D'.$i,'REQUESTER DESIGNATION')->getStyle('D'.$i)->getFont()->setBold(true);
				$i++;
				$obj->getActiveSheet()->setCellValue('D'.$i,'REQUESTER DEPARTMENT')->getStyle('D'.$i)->getFont()->setBold(true);
			}
			else{
				$obj->getActiveSheet()->setCellValue('A'.$i,'REFERENCE NUMBER')->getStyle('A'.$i)->getFont()->setBold(true);
				$obj->getActiveSheet()->setCellValue('D'.$i,'SENDER NAME')->getStyle('D'.$i)->getFont()->setBold(true);
				$i++;
				$obj->getActiveSheet()->setCellValue('D'.$i,'SENDER DESIGNATION')->getStyle('D'.$i)->getFont()->setBold(true);
				$i++;
				$obj->getActiveSheet()->setCellValue('D'.$i,'SENDER DEPARTMENT')->getStyle('D'.$i)->getFont()->setBold(true);
			}
			$obj->getActiveSheet()->setCellValue('B'.$j,$entry->KEY_ID);	
			$obj->getActiveSheet()->setCellValue('E'.$j,$entry->NAME);
			$j++;
			$obj->getActiveSheet()->setCellValue('A'.$j,'DATE')->getStyle('A'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('B'.$j,$entry->ENTRY_DATE);
			$obj->getActiveSheet()->setCellValue('E'.$j,$entry->DESIGNATION);
			$j++;
			$obj->getActiveSheet()->setCellValue('A'.$j,'SITE')->getStyle('A'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('B'.$j,$entry->SITE);
			$obj->getActiveSheet()->setCellValue('E'.$j,$entry->DEPARTMENT);
			$j++;
			$obj->getActiveSheet()->setCellValue('A'.$j,'INVOICE NUMBER')->getStyle('A'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('B'.$j,$entry->INVOICE_NUMBER);
			$j++;
			$obj->getActiveSheet()->setCellValue('A'.$j,'LC NUMBER')->getStyle('A'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('B'.$j,$entry->LC_NUMBER);
			$j++;
			$obj->getActiveSheet()->setCellValue('A'.$j,'LOT NUMBER')->getStyle('A'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('B'.$j,$entry->LOT_NUMBER);
			$j++;
			if($type == "manufacturing-issue" || $type == "spare-issue"){
				$obj->getActiveSheet()->setCellValue('A'.$j,'PPD NUMBER')->getStyle('A'.$j)->getFont()->setBold(true);
				$obj->getActiveSheet()->setCellValue('B'.$j,$entry->PPD_NUMBER);
			}

			$i = $j+2;
			$obj->getActiveSheet()->setCellValue('A'.$j,'PART NUMBER')->getStyle('A'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('B'.$j,'PART NAME')->getStyle('B'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('C'.$j,'MODEL')->getStyle('C'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('D'.$j,'COLOR CODE')->getStyle('D'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('E'.$j,'COLOR NAME')->getStyle('E'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('F'.$j,'QUANTITY')->getStyle('F'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('G'.$j,'UNIT')->getStyle('G'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('H'.$j,'FRAME NUMBER')->getStyle('H'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('I'.$j,'ENGINE NUMBER')->getStyle('I'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('J'.$j,'CRIPPLE REASON')->getStyle('J'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('K'.$j,'REMARKS')->getStyle('K'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->getStyle('A'.$j . ':K' . $j)->applyFromArray($border_style);
	...
	if($main_table == "delivery" && $parts_table == "delivery_parts"){
		...
		foreach ($entries as $entry) {
			...
			$obj->getActiveSheet()->getStyle('A'.$j.':N'.$j)->applyFromArray($border_style);
	...
	if($main_table == "claims" && $parts_table == "claims_parts"){
		...
		foreach ($entries as $entry) {
			...
			$obj->getActiveSheet()->setCellValue('D'.$j,'MODEL')->getStyle('D'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('E'.$j,$entry->MODEL);
			$j++;
			...
			$obj->getActiveSheet()->setCellValue('A'.$j,'PART NUMBER')->getStyle('A'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('B'.$j,'PART NAME')->getStyle('B'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('C'.$j,'COLOR CODE')->getStyle('C'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('D'.$j,'COLOR NAME')->getStyle('D'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('E'.$j,'QUANTITY')->getStyle('E'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('F'.$j,'UNIT')->getStyle('F'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('G'.$j,'BOX NUMBER')->getStyle('G'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('H'.$j,'CASE NUMBER')->getStyle('H'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('I'.$j,'REFERENCE NUMBER')->getStyle('I'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('J'.$j,'LOT NUMBER')->getStyle('J'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('K'.$j,'CLAIM TYPE')->getStyle('K'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('L'.$j,'CLAIM CODE')->getStyle('L'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('M'.$j,'ACTION CODE')->getStyle('M'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('N'.$j,'PROCESS CODE')->getStyle('N'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('O'.$j,'DETAILS OF DEFECT')->getStyle('O'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('P'.$j,'DEFECT FINDING WAY')->getStyle('P'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->setCellValue('Q'.$j,'REMARKS')->getStyle('Q'.$j)->getFont()->setBold(true);
			$obj->getActiveSheet()->getStyle('A'.$j.':Q'.$j)->applyFromArray($border_style);
...
if($report_type == "pdf"){	
	...
	if($main_table == "stock" && $parts_table == "stock_parts"){
		if($selection_value == "hour"){
			if($type == "ckd" || $type == "ckdbom" || $type == "cbu" || $type == "manufacturing-parts" || $type == "spare-parts" || $type == "additional-parts"){
				...
				if($type == "additional-parts"){
					$stmt = $con->query("SELECT MAX(DATE(ENTERED_AT)) AS MAX_PARTS_DATE FROM additional_delivery WHERE TYPE = '$type'");
				}
				else if($type == "spare-parts"){
					$stmt = $con->query("SELECT MAX(DATE(ENTERED_AT)) AS MAX_PARTS_DATE FROM backup_delivery WHERE TYPE = '$type'");
				}
				else{
				...
				if($max_entry_date->MAX_ENTRY_DATE >= $max_parts_date->MAX_PARTS_DATE) { $table = "entries"; $sub_table = "parts"; }
					...
					if($type == "additional-parts") { $table = "additional_delivery"; $sub_table = "delivery_parts"; }
					else if($type == "spare-parts") { $table = "backup_delivery"; $sub_table = "delivery_parts"; }
					else { $table = "issues"; $sub_table = "issue_records"; }
				}

				$stmt = $con->prepare("SELECT DISTINCT DATE(ENTERED_AT) AS ENTRY_DATE FROM $table WHERE DATE(NOW()) = DATE(ENTERED_AT) AND HOUR(NOW()) - HOUR(ENTERED_AT) <= :ENTERED_AT AND TYPE = :TYPE ORDER BY HOUR(ENTERED_AT)");
				$stmt->execute(array('ENTERED_AT' => htmlspecialchars($_POST['hour']), 'TYPE' => $type));
		...
		if($selection_value == "date-range"){
			...
			if($type == "ckd" || $type == "ckdbom" || $type == "cbu" || $type == "manufacturing-parts" || $type == "spare-parts" || $type == "additional-parts"){
				...
				if($type == "additional-parts"){
					$stmt = $con->query("SELECT DISTINCT DATE(ENTERED_AT) AS ENTRY_DATE FROM $table WHERE DATE(ENTERED_AT) BETWEEN '$starting_date' AND '$end_date' AND TYPE = 'additional-parts' UNION SELECT DISTINCT DATE(ENTERED_AT) AS ENTRY_DATE FROM additional_delivery WHERE DATE(ENTERED_AT) BETWEEN '$starting_date' AND '$end_date' ORDER BY ENTRY_DATE");
					$dates = $stmt->fetchAll(\PDO::FETCH_OBJ);
				}
				else if($type == "spare-parts"){
					$stmt = $con->query("SELECT DISTINCT DATE(ENTERED_AT) AS ENTRY_DATE FROM $table WHERE DATE(ENTERED_AT) BETWEEN '$starting_date' AND '$end_date' WHERE TYPE = 'spare-parts' UNION SELECT DISTINCT DATE(ENTERED_AT) AS ENTRY_DATE FROM backup_delivery WHERE DATE(ENTERED_AT) BETWEEN '$starting_date' AND '$end_date' ORDER BY ENTRY_DATE");
					$dates = $stmt->fetchAll(\PDO::FETCH_OBJ);
				}
				else{
					$stmt = $con->prepare("SELECT DISTINCT DATE(ENTERED_AT) AS ENTRY_DATE FROM $table WHERE DATE(ENTERED_AT) BETWEEN :STARING_DATE AND :ENDING_DATE ORDER BY ENTRY_DATE AND TYPE = :TYPE");
					$stmt->execute(array('STARING_DATE' => $starting_date, 'ENDING_DATE' => $end_date, 'TYPE'=>$type));
					$dates = $stmt->fetchAll(\PDO::FETCH_OBJ);	
				}
			}
		...
		if($selection_value == "specify-date"){
			...
			if($type == "ckd" || $type == "ckdbom" || $type == "cbu" || $type == "manufacturing-parts" || $type == "spare-parts" || $type == "additional-parts"){
				...
				$max_entry_date = $stmt->fetch(\PDO::FETCH_OBJ);
				if($type == "additional-parts"){
					$stmt = $con->query("SELECT MAX(DATE(ENTERED_AT)) AS MAX_PARTS_DATE FROM additional_delivery");
				}
				else if($type == "spare-parts"){
					$stmt = $con->query("SELECT MAX(DATE(ENTERED_AT)) AS MAX_PARTS_DATE FROM backup_delivery");
				}
				else{
					$stmt = $con->query("SELECT MAX(DATE(ENTERED_AT)) AS MAX_PARTS_DATE FROM issues WHERE TYPE = '$type'");	
				}
				...
				if($type == "additional-parts" || $type == "spare-parts") { 
					$stmt = $con->prepare("SELECT DISTINCT DATE(ENTERED_AT) AS ENTRY_DATE FROM $table WHERE DATE(ENTERED_AT) = :SPECIFIED_DATE");	
					$stmt->execute(array('SPECIFIED_DATE' => $date));
				}
				else{
	...
	if($main_table == "pending" && $parts_table == "pending_parts"){
		if($selection_value == "hour"){
			$stmt = $con->prepare("SELECT DISTINCT DATE(ENTERED_AT) AS ENTRY_DATE FROM issues WHERE DATE(NOW()) = DATE(ENTERED_AT) AND HOUR(NOW()) - HOUR(ENTERED_AT) <= :ENTERED_AT ORDER BY HOUR(ENTERED_AT)");
			$stmt->execute(array('ENTERED_AT' => htmlspecialchars($_POST['hour'])));
		}
		if($selection_value == "date-range"){
			$date_parts = explode('-', htmlspecialchars($_POST['date-range-start']));
			...
			$date_parts = explode('-', htmlspecialchars($_POST['date-range-end']));
			$end_date = $date_parts[2] . '-' . $date_parts[1] . '-' . $date_parts[0];
			$stmt = $con->prepare("SELECT DISTINCT DATE(ENTERED_AT) AS ENTRY_DATE FROM issues WHERE DATE(ENTERED_AT) BETWEEN :STARING_DATE AND :ENDING_DATE ORDER BY DATE(ENTERED_AT)");
			$stmt->execute(array('STARING_DATE' => $starting_date, 'ENDING_DATE' => $end_date));
		}
		if($selection_value == "specify-date"){
			$date_parts = explode('-', htmlspecialchars($_POST['specify-date']));
		...
		// SET VALUES
		if($type == "ckd-issue") { $title = "CKD In Progress"; }
		if($type == "ckd-bom-issue") { $title = "CKD By BOM In Progress"; }
		if($type == "cbu-issue") { $title = "CBU In Progress"; }
		...
		foreach($dates as $date){
			$page = "";
			// oi date e parts entry te ki ki unique models dhukse
			$stmt = $con->query("SELECT DISTINCT MODEL 
								 FROM issue_records
								 WHERE ENTRY_REFERENCE_ID IN (SELECT KEY_ID FROM issues WHERE TYPE = '$type' AND RECEIVED != 1 AND DATE(ENTERED_AT) = '$date->ENTRY_DATE')" );
			$unique_models = $stmt->fetchAll(\PDO::FETCH_OBJ);

			foreach($unique_models as $model){
				$tmp = "";
				$stmt = $con->query("SELECT COUNT(*) AS NUM_ENTRIES, SUM(QUANTITY) AS ISSUED_QUANTITY, MODEL, COLOR_CODE, COLOR_NAME
								FROM issue_records
								WHERE MODEL = '$model->MODEL'
								AND ENTRY_REFERENCE_ID IN (SELECT KEY_ID FROM issues WHERE TYPE = '$type' AND RECEIVED != 1 AND DATE(ENTERED_AT) = '$date->ENTRY_DATE')
								GROUP BY MODEL,COLOR_CODE");
				...
				foreach ($entry_num as $e) {
					$stmt = $con->query("SELECT COUNT(*) AS ISSUE_ENTRY_QUANTITY, SUM(QUANTITY) AS RECEIVED_QUANTITY
									FROM issue_records
									WHERE MODEL = '$e->MODEL'
									AND COLOR_CODE = '$e->COLOR_CODE'
									AND ENTRY_REFERENCE_ID IN 
									(SELECT KEY_ID FROM issues WHERE TYPE = '$type' AND DATE(ENTERED_AT) = '$date->ENTRY_DATE' AND RECEIVED = 1 )
									GROUP BY MODEL,COLOR_CODE
									");
					...
					if($quantity > 0){
						$num_of_valid_values++;
						$tmp .= "<tr>
							<td style='width:100px; color: #333; font-size: 12px; font-family: helvetica, sans-serif; border: 1px solid #ababab; padding:3px; font-weight:bold;'>$e->COLOR_CODE</td>
							<td style='width:100px; color: #333; font-size: 12px; font-family: helvetica, sans-serif; border: 1px solid #ababab; padding:3px; font-weight:bold;'>$e->COLOR_NAME</td>
							<td style='width:100px; color: #333; font-size: 12px; font-family: helvetica, sans-serif; border: 1px solid #ababab; padding:3px; font-weight:bold;'>$quantity</td>
						</tr>
						";
					} // QUANTITY != 0 END
				} // ENTRY NUM END 
				if(!empty($tmp)){
					...
					<table style = 'width:100%;'>
					<tr>
						<td rowspan='$num_of_valid_values' style='width:100px; color: #333; text-align: center; font-size: 12px; font-family: helvetica, sans-serif; border: 1px solid #ababab; padding:3px;'>$model->MODEL</td>
					";
					$tmp = substr($tmp, 4);
					$page .= $tmp;
				}
			...
			if(!empty($page)){
				...
				<table style = 'width:100%; margin-bottom: 10px;'>
					<tr>
						<td style='width:100px; background: #ddd; color: #333; font-size: 12px; font-family: helvetica, sans-serif; border: 1px solid #ababab; padding:3px; font-weight:bold; text-align:center;'>MODEL</td>
						<th style='width:100px; background: #ddd; color: #333; font-size: 12px; font-family: helvetica, sans-serif; border: 1px solid #ababab; padding:3px; font-weight:bold;'>COLOR CODE</th>
						<th style='width:100px; background: #ddd; color: #333; font-size: 12px; font-family: helvetica, sans-serif; border: 1px solid #ababab; padding:3px; font-weight:bold;'>COLOR NAME</th>
						<th style='width:100px; background: #ddd; color: #333; font-size: 12px; font-family: helvetica, sans-serif; border: 1px solid #ababab; padding:3px; font-weight:bold;'>QUANTITY</th>
					</tr>
				";
				$content .= $page;
				$content .= footer_info("pending",$limit,$count);
				$count++;
