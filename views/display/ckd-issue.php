...
<div class="topbar">
    <div class="breadcrumbs">
        ...
        <a href="#"><span>CKD Issue to Assembly</span></a>
    </div> <!-- /breadcrumbs -->
    <div class="signin">
        <span>Hey, Admin</span>
    </div> <!-- /signin -->
...
<div class="content">
	<h1 class="page-title">
		<span class="title">CKD Issue to Assembly</span>
		<a href="<?php echo $base_url;?>/views/forms/ckd-issue-enter.php" class="btn btn-primary btn-sm pull-right">
				...
				foreach ($ckds as $c) {
					...
					<tr class='$class_name' id='row-num-$i'>
						...
						<td class='fixed-width'>
							<a href='$base_url/views/display/ckd-issue-details.php?ref=$c->KEY_ID' class='btn btn-primary btn-sm'>Details</a>
