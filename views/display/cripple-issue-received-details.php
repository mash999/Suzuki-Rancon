...
if(isset($_GET['ref']))	{
	...
	$stmt->execute(array('KEY_ID' => $ref, 'TYPE' => 'cripple-issue', 'RECEIVED' => 1));
	$row = $stmt->fetch(\PDO::FETCH_OBJ);
	if(!$row){
		echo "<script>window.location.href = 'cripple-issue-received.php';</script>";
	}
}
else echo "<script>window.location.href = 'cripple-issue-received.php';</script>";
?>
...
<div class="topbar">
    <div class="breadcrumbs">
        ...
        <a href="cripple-issue-received.php"><span>Cripple Issues Received</span></a>
        <i class="fa fa-caret-right" aria-hidden="true"></i>
        <a href="#"><span>Cripple Issues Received Details</span></a>
    </div> <!-- /breadcrumbs -->
    <div class="signin">
        <span>Hey, Admin</span>
    </div> <!-- /signin -->
...
<div class="content">
	<h1 class="page-title">
		<span class="title">Cripple Issues Received Details</span>
			...
			<tbody>
				...
				foreach ($rows as $r) {
					...
					<tr class='show-row'>
						...
						<td>
							<span class = 'cell-value'>$r->CRIPPLE_REASON</span>
							<input type='text' class='edit-input'>
						</td>
						...
						<td class='fixed-width'>
							...
							<a href='$base_url/functions/process-forms.php?del=execute&param=KEY_ID&target=$r->KEY_ID&entity=issue_records&page=display/cripple-issue-received-details.php?ref=$ref' class='btn btn-default' onclick=\"return confirm('Are you sure that you want to delete this record?');\"><i class = 'fa fa-trash'></i></a>
						</td>
					</tr>";
				}
				?>
