...
if(isset($_GET['ref']))	{
	...
	if(!$row){
		echo "<script>window.location.href = 'purchase-requisitions.php';</script>";
	}
}
else echo "<script>window.location.href = 'purchase-requisitions.php';</script>";
?>


<div class="topbar">
    <div class="breadcrumbs">
        <a href="purchase-requisitions.php"><i class="fa fa-money"></i>Purchase Requisitions</a>
        <i class="fa fa-caret-right" aria-hidden="true"></i>
        <a href="#">Purchase Requisitions Details</a>
    </div> <!-- /breadcrumbs -->
    <div class="signin">
        <span>Hey, Admin</span>
    </div> <!-- /signin -->
...
<div class="content">
	<h1 class="page-title">
		<span class="title">Purchase Requisitions Details</span>
		...
		<a href="<?php echo $base_url;?>/views/forms/purchase-requisitions-edit.php?ref=<?php echo $ref;?>" class="btn btn-primary btn-sm pull-right">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 detail-info no-padding">
		<h3>
			...
			<?php if($_SESSION['rancon_access_level'] > 1){ ?>  
			<a href="#" class="btn btn-primary btn-sm pull-right delete-records" data-main="purchase_requisitions" data-section="purchase_requisitions_parts" data-ref="<?php echo $ref;?>" style="margin-left: 5px;">Delete</a> 
			<span data-key="<?php echo $ref;?>" data-section="purchase-requisitions" class="btn btn-primary btn-sm pull-right activate-edit" style="margin-left: 5px;">Edit</span>
			<?php } ?>
			<button class="export-file btn btn-primary btn-sm pull-right" data-action="print" data-entries="purchase_requisitions" data-parts = "purchase_requisitions_parts" data-key="<?php echo $row->KEY_ID;?>" data-file-name = "purchase_requisitions" style="margin-left: 5px;">Print</button>
			<button class="export-file btn btn-primary btn-sm pull-right" data-action="export-excel" data-entries="purchase_requisitions" data-parts = "purchase_requisitions_parts" data-key="<?php echo $row->KEY_ID;?>" data-file-name = "purchase_requisitions" style="margin-left: 5px;">Get Excel</button>
		</h3>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 table-responsive info-table no-padding-left">
			<table class="table table-bordered">
				<tr>
					<th>Date</th>
					<td>
						<span class="cell-value"><?php echo date("d-m-Y", strtotime($row->REQUISITION_DATE));?></span>
				...
				foreach ($rows as $r) {
					...
					<tr class='show-row'>
						...
						<td class='fixed-width'>
							<a href='#' data-type='purchase-requisitions' data-key='$r->KEY_ID' class='inline-edit btn btn-default'><i class='fa fa-pencil'></i></a>
							<a href='$base_url/functions/process-forms.php?del=execute&param=KEY_ID&target=$r->KEY_ID&entity=purchase_requisitions_parts&page=display/purchase-requisitions-details.php?ref=$ref' class='btn btn-default' onclick=\"return confirm('Are you sure that you want to delete this record?');\"><i class = 'fa fa-trash'></i></a>
						</td>
					</tr>";
				}
				?>
...
<div id="parts-modal" class="content-modal">
	...
	<div class="content-modal-body">
		<h3>Parts of this Requisitions</h3>
		<h4>
			Requisition Number  - <?php echo $row->KEY_ID;?>
		</h4>
