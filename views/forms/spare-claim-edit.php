...
if(isset($_GET['ref'])){
	...
	if($_SESSION['rancon_access_level'] <= 1){
		echo "<script>location.href='$base_url/views/display/spare-claim-details.php?ref=$ref';</script>";
		die();
	}
...
<div class="topbar">
    <div class="breadcrumbs">
        ...
        <a href="../display/spare-claim.php"><span>Claims for Spare Parts</span></a>
        <i class="fa fa-caret-right" aria-hidden="true"></i>
        <a href="#"><span>Claims for Spare Parts Edit</span></a>
    </div> <!-- /breadcrumbs -->
    <div class="signin">
        <span>Hey, Admin</span>
    </div> <!-- /signin -->
...
<div class="content">
	<h1 class="form-title page-title">
		<span class="title">Claims for Spare Parts Edit Form</span>
	</h1>	
	...
	<form action="<?php echo $base_url;?>/functions/process-forms.php" method="post" enctype="multipart/form-data" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-input">
			...
			<?php echo "<span class='return-page hidden'>$base_url/views/display/spare-claim-details.php?ref=$ref</span>";?>
			<a href="../display/spare-claim-details.php?ref=<?php echo $ref;?>" class="btn btn-primary">Cancel</a>
		</div> <!-- /form-input -->
	</form>
