...
<div class="topbar">
    <div class="breadcrumbs">
        ...
        <a href="../display/additional-claim.php"><span>Claims for Additional Parts</span></a>
        <i class="fa fa-caret-right" aria-hidden="true"></i>
        <a href="#"><span>Claims for Additional Parts Edit</span></a>
    </div> <!-- /breadcrumbs -->
    <div class="signin">
        <span>Hey, Admin</span>
    </div> <!-- /signin -->
...
<div class="content">
	<h1 class="form-title page-title">
		<span class="title">Claims for Additional Parts Edit Form</span>
	</h1>	
	...
	<form action="<?php echo $base_url;?>/functions/process-forms.php" method="post" enctype="multipart/form-data" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-input">
			...
			<?php echo "<span class='return-page hidden'>$base_url/views/display/additional-claim-details.php?ref=$ref</span>";?>
			<a href="../display/additional-claim-details.php?ref=<?php echo $ref;?>" class="btn btn-primary">Cancel</a>
		</div> <!-- /form-input -->
	</form>
