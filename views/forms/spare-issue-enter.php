...
<div class="topbar">
    <div class="breadcrumbs">
        ...
        <i class="fa fa-caret-right" aria-hidden="true"></i>
        <a href="#"><span>Backup Spare Parts Issue to Assembly Form</span></a>
    </div> <!-- /breadcrumbs -->
    <div class="signin">
        <span>Hey, Admin</span>
    </div> <!-- /signin -->
...
<div class="content">
	<h1 class="form-title page-title">
		<span class="title">Backup Spare Parts Issue to Assembly Form</span>
	</h1>	
	...
	<form action="<?php echo $base_url;?>/functions/process-forms.php" method="post" enctype="multipart/form-data" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-input">
			...
			<a href="../display/spare-issue.php" class="btn btn-primary">Cancel</a>
			<br><br>
			<p id="file-name"></p>
		</div> <!-- /form-input -->
	</form>
