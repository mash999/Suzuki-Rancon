...
if(isset($_GET['ref'])){
	...
	if($_SESSION['rancon_access_level'] <= 1){
		echo "<script>location.href='$base_url/views/display/ckd-issue-received-details.php?ref=$ref';</script>";
		die();
	}
...
<div class="topbar">
    <div class="breadcrumbs">
        ...
        <i class="fa fa-caret-right" aria-hidden="true"></i>
        <a href="#"><span>CKD Issues Received Edit</span></a>
    </div> <!-- /breadcrumbs -->
    <div class="signin">
        <span>Hey, Admin</span>
    </div> <!-- /signin -->
...
<div class="content">
	<h1 class="form-title page-title">
		<span class="title">CKD Issues Received Edit</span>
	</h1>	
		...
		<div class="entity-holder" data-entity="issues" data-getin="KEY_ID">
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-input">
				...
				<select id="received-requisition-number" name="reference-number" class="form-control" data-type="ckd-issue" required>
					...
					<?php 
					$stmt = $con->query("SELECT KEY_ID FROM issues WHERE TYPE = 'ckd-issue' ORDER BY KEY_ID DESC");
