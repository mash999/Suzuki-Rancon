...
if(isset($_GET['ref'])){
	...
	if($_SESSION['rancon_access_level'] <= 1){
		echo "<script>location.href='$base_url/views/display/ckd-issue-details.php?ref=$ref';</script>";
		die();
	}
	$ckd_issue =  fetch_functions\get_row('issues','KEY_ID', $ref)[0];
	$ckd_parts =  fetch_functions\get_row('issue_records','ENTRY_REFERENCE_ID', $ref);
}
else{
...
<div class="topbar">
    <div class="breadcrumbs">
        ...
        <i class="fa fa-caret-right" aria-hidden="true"></i>
        <a href="#"><span>CKD Issue to Assembly Edit</span></a>
    </div> <!-- /breadcrumbs -->
    <div class="signin">
        <span>Hey, Admin</span>
    </div> <!-- /signin -->
...
<div class="content">
	<h1 class="form-title page-title">
		<span class="title">CKD Issue to Assembly Edit</span>
	</h1>	
	...
	<form action="<?php echo $base_url;?>/functions/process-forms.php" method="post" enctype="multipart/form-data" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
		<div class="entity-holder" data-entity="issues" data-getin="KEY_ID">
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-input">
				...
				<input type="text" id="requisition-number" class="form-control edit-bulk-inputs" placeholder="Requisition Number" data-in="KEY_ID" data-get="<?php echo $ref;?>" value="<?php echo $ckd_issue->KEY_ID;?>" readonly>
			</div> <!-- /form-input -->
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-input">
				...
				<input type="text" id="date" class="form-control edit-bulk-inputs date-picker" placeholder="Date" data-in="ENTRY_DATE" data-get="<?php echo $ref;?>" value="<?php echo date('d-m-Y',strtotime($ckd_issue->ENTRY_DATE));?>" required>
			</div> <!-- /form-input -->
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-input">
				...
				<input type="text" id="site" class="form-control edit-bulk-inputs" placeholder="Site" data-in="SITE" data-get="<?php echo $ref;?>" value="<?php echo $ckd_issue->SITE;?>" required>
			</div> <!-- /form-input -->
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-input">
				...
				<input type="text" id="name" class="form-control edit-bulk-inputs" placeholder="Requester Name" data-in="NAME" data-get="<?php echo $ref;?>" value="<?php echo $ckd_issue->NAME;?>" required>
			</div> <!-- /form-input -->
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-input">
				...
				<input type="text" id="designation" class="form-control edit-bulk-inputs" placeholder="Requester Designation" data-in="DESIGNATION" data-get="<?php echo $ref;?>" value="<?php echo $ckd_issue->DESIGNATION;?>" required>
			</div> <!-- /form-input -->
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-input">
				...
				<input type="text" id="department" class="form-control edit-bulk-inputs" placeholder="Requester Department" data-in="DEPARTMENT" data-get="<?php echo $ref;?>" value="<?php echo $ckd_issue->DEPARTMENT;?>" required>
			</div> <!-- /form-input -->
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-input">
				...
				<input type="text" id="invoice-no" class="form-control edit-bulk-inputs" placeholder="Invoice Number" data-in="INVOICE_NUMBER" data-get="<?php echo $ref;?>" value="<?php echo $ckd_issue->INVOICE_NUMBER;?>" required>
			</div> <!-- /form-input -->
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-input">
				...
				<input type="text" id="lc-no" class="form-control edit-bulk-inputs" placeholder="LC Number" data-in="LC_NUMBER" data-get="<?php echo $ref;?>" value="<?php echo $ckd_issue->LC_NUMBER;?>" required>
			</div> <!-- /form-input -->
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-input">
				...
				<input type="text" id="lot-no" class="form-control edit-bulk-inputs" placeholder="Lot Number" data-in="LOT_NUMBER" data-get="<?php echo $ref;?>" value="<?php echo $ckd_issue->LOT_NUMBER;?>">
			</div> <!-- /form-input -->
		</div> <!-- entity-holder -->
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-input">
			...
			<?php echo "<span class='return-page hidden'>$base_url/views/display/ckd-issue-details.php?ref=$ref</span>";?>
			<a href="../display/ckd-issue-details.php?ref=<?php echo $ref;?>" class="btn btn-primary">Cancel</a>
		</div> <!-- /form-input -->
	</form>
