...
<div class="topbar">
    <div class="breadcrumbs">
        ...
        <a href="../display/cripple-issue-received.php"><span>Cripple Issues Received</span></a>
        <i class="fa fa-caret-right" aria-hidden="true"></i>
        <a href="#"><span>Cripple Issues Received Form</span></a>
    </div> <!-- /breadcrumbs -->
    <div class="signin">
        <span>Hey, Admin</span>
    </div> <!-- /signin -->
...
<div class="content">
	<h1 class="form-title page-title">
		<span class="title">Cripple Issues Received Form</span>
	</h1>	
	...
	<form action="<?php echo $base_url;?>/functions/process-forms.php" method="post" enctype="multipart/form-data" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 form-input">
			...
			<select id="received-requisition-number" name="reference-number" class="form-control" data-type="cripple-issue" required>
				<option value="">Select Reference Number</option>
				<?php 
				$stmt = $con->query("SELECT KEY_ID FROM issues WHERE TYPE = 'cripple-issue' ORDER BY KEY_ID DESC");
			...
			<table>
				...
				<tbody id="set-body">
					...
					<tr>
						...
						<td><input type="text" name="cripple-reason[]" placeholder="Cripple Reason" value=""></td>
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-input">
			...
			<a href="../display/cripple-issue-received.php" class="btn btn-primary">Cancel</a>
			<br><br>
			<p id="file-name"></p>
		</div> <!-- /form-input -->
	</form>
